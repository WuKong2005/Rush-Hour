...
RESET_BOX = pygame.Rect(board_x, table_start_y + TABLE_SIZE_HEIGHT * 13 // 12, BOARD_SIZE // 4, TABLE_SIZE_HEIGHT / 8)
...
while running:
    ...
    render_text_center(screen, font, "START", board_x + BOARD_SIZE * 3 // 8, table_start_y + TABLE_SIZE_HEIGHT * 13 // 12, BOARD_SIZE // 4, TABLE_SIZE_HEIGHT / 8, "black", "white")

    pygame.draw.rect(screen, "red", RESET_BOX)
    pygame.draw.rect(screen, "black", RESET_BOX, width=3)
    render_text_center(screen, font, "RESET", board_x, table_start_y + TABLE_SIZE_HEIGHT * 13 // 12, BOARD_SIZE // 4, TABLE_SIZE_HEIGHT / 8, "black", "white")
